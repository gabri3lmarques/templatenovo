  ...
  function layoutLeitor(){
    ...
    HTMLstring+='<head>\n';
    HTMLstring+='    <link href="./css/bootstrap.min.css" rel="stylesheet">\n';
    HTMLstring+='    <link href="./css/sncload.css" rel="stylesheet">\n';
    HTMLstring+='    <link href="./css/fa/css/font-awesome.min.css" type="text/css" rel="stylesheet">\n';
    HTMLstring+='    <link href="./css/cores.css" type="text/css" media="all" rel="stylesheet">\n';
    HTMLstring+='    <link href="./css/leitor.css" type="text/css" media="all" rel="stylesheet">\n';
    HTMLstring+='    <link href="./css/print.css" type="text/css" rel="stylesheet">\n';
    ...
    HTMLstring+='</div>\n';
    HTMLstring+='\n';
    HTMLstring+='<script src="./js/jquery.min.js"></script>\n';
    HTMLstring+='<script src="./js/print.js"></script>\n';
